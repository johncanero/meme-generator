  ...
  return (
    <div>
      ...
      <div className="flex justify-center mx-auto mt-6 relative md:mt-9 md:mb-28 sm:w-80 md:w-128 lg:h-120">
        ...
        <h2 className="absolute flex justify-center p-5 font-Poppins font-bold uppercase text-4xl text-white top-0">{meme.topText}</h2>
        <h2 className="absolute flex justify-center p-5 font-Poppins font-bold uppercase text-4xl text-white bottom-0">{meme.bottomText}</h2>
      </div>
    </div>
  );
};
