...
const Meme = () => {
  return (
    <div>
      ...
      {/* Button */}
      <button className="flex mx-auto  bg-gradient-to-r from-memeYellow to-memeOrange text-memeViolet font-bold py-3   text-lg md:text-xl rounded-lg px-9 mt-6 md:px-52">
